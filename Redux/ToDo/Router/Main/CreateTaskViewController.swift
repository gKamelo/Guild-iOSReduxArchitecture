...
final class CreateTaskViewController: UIViewController, UITextViewDelegate, DatePickerViewControllerDelegate, StoreSubscriber {
    ...
    static let identifier: String = "createTask"
    ...
    @IBAction func onExitAction(_ sender: UIBarButtonItem) {
        let toRemoveCreate = SetRouteAction([TasksViewController.identifier], animated: true)

        store.dispatch(toRemoveCreate)
    }
